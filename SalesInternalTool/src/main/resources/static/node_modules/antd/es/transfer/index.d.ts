...
import type { TransferListProps } from 'antd/es/transfer/list';
...
declare class Transfer<RecordType extends TransferItem = TransferItem> extends React.Component<TransferProps<RecordType>, TransferState> {
    ...
    static Operation: ({ disabled, moveToLeft, moveToRight, leftArrowText, rightArrowText, leftActive, rightActive, className, style, direction, oneWay, }: import("antd/es/transfer/operation").TransferOperationProps) => JSX.Element;
